...
state("Subnautica", "March 2023")
{
    ...
    float XCoord:              "UnityPlayer.dll", 0x17F2E30, 0x150, 0x38, 0x18, 0x958; // 0 in menu
    float YCoord:              "UnityPlayer.dll", 0x17F2E30, 0x150, 0x38, 0x18, 0x95C; //1.75 in menu
    float ZCoord:              "UnityPlayer.dll", 0x17F2E30, 0x150, 0x38, 0x18, 0x960; // 0 in menu
